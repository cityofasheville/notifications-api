...
select count(*) count, permit_group,permit_type,permit_subtype from simplicity.simplicity_permits_view
where permit_group = 'Planning'
group by permit_group,permit_type,permit_subtype 
order by permit_group,permit_type,permit_subtype 